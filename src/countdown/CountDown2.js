...
// Uso incorreto de setInterval: Você está usando setInterval duas vezes para atualizar o contador. 
// Isso pode causar problemas de sincronização. É melhor usar apenas um setInterval para isso.
